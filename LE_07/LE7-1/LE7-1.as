...
;; *************** function _main *****************
;; Defined at:
;;		line 85 in file "C:\Users\notjo\OneDrive\Desktop\USC\USC-Year3-Sem2\3201-EmbeddedSystems\Labs\LE_07\LE7-1\LE7-1.c"
...
l556:	
;LE7-1.c: 90: {
;LE7-1.c: 91: I2C_Start();
	fcall	_I2C_Start
	line	92
	
l558:	
;LE7-1.c: 92: I2C_Send(0x10);
	movlw	(010h)
	fcall	_I2C_Send
	line	93
	
l560:	
;LE7-1.c: 93: I2C_Send(PORTD);
...
l564:	
;LE7-1.c: 95: _delay((unsigned long)((200)*(4000000/4000.0)));
	opt asmopt_off
movlw  2
movwf	((??_main+0)+0+2),f
movlw	4
...
l532:	
;LE7-1.c: 110: TRISC3 = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	bsf	(1083/8)^080h,(1083)&7	;volatile
	line	111
;LE7-1.c: 111: TRISC4 = 1;
	bsf	(1084/8)^080h,(1084)&7	;volatile
	line	112
	
l534:	
;LE7-1.c: 112: SSPCON = 0x28;
	movlw	(028h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(20)	;volatile
...
l538:	
;LE7-1.c: 115: SSPSTAT = 0x00;
	clrf	(148)^080h	;volatile
	line	116
;LE7-1.c: 116: SSPADD = 0x09;
	movlw	(09h)
...
l544:	
;LE7-1.c: 152: I2C_Wait();
	fcall	_I2C_Wait
	line	154
	
l546:	
;LE7-1.c: 154: SSPBUF = data;
...
l526:	
;LE7-1.c: 122: while((SSPCON2 & 0x1F) || (SSPSTAT & 0x04));
	goto	l528
